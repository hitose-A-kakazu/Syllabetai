...
　
＊＊＊＊＊＊PDFが読み込めなかった場合、手動で単位状況を入力し、データベース作成しようと考えていたのですが間に合わなかったです。(self_select.py)

#####テスト用の成績として、２人の成績を置いています。
test_seiseki1.pdfのパスワード：Hts1997ioe0913
test_seiseki2.pdfのパスワード：Kenya1023
